 ...
 * main RAM is 16 KiB and no more, so the interpreter and that memory
 * share the Black Pill's program region: this one is loaded with 'run'
 * as well as installed in flash.  4K and 8K BASIC fit.  Extended BASIC's
 * loader sits at 3F00h, inside this RAM, and leaves a little workspace.
 * Disk BASIC's loader is at 7E00h and does not fit.
 *
