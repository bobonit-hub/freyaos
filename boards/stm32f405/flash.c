/*
 * Freya - internal flash programming for the STM32F405xx.
 *
 ...
 * bound on a 168 MHz poll loop, not a timing reference. */
...
/* Only the auto-start sector (3) and program sector (4) are writable. */
