/*
 * Freya - minimal STM32F405xx register definitions.
 ...
 * below match RM0090.  The F405 I2C is the original peripheral; Freya
 * bit-bangs both buses, so that block is not described here.
 */
#ifndef FREYA_STM32F405_H
#define FREYA_STM32F405_H
...
#define RCC_CFGR_PPRE1_DIV4 (5UL << 10)   /* APB1 max is 42 MHz at 168 */
#define RCC_CFGR_PPRE2_DIV1 (0UL << 13)
#define RCC_CFGR_PPRE2_DIV2 (4UL << 13)   /* APB2 max is 84 MHz at 168 */
