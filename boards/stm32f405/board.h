 ...
 * the include path.
 *
 * The crystal is 8 MHz.  Pins follow the other ports: console on PA2/PA3,
 * SD on SPI1 (PA4..PA7) with the socket supply on PA8, LED on PC13.
 */
...
/* ------------------------------------------------------------ identity */
#define BOARD_NAME          "STM32F405xx"
#define BOARD_MCU           "STM32F405xx"
 ...
 * sector map.  The kernel, the auto-start slot and the program all sit
 ...
 * is whatever the card and the wiring stand.  PCLK2 is 84 MHz here. */
#define BOARD_SPI_BR_SLOW   7           /* /256 = 328 kHz                */
#define BOARD_SPI_BR_FAST   2           /* /8   = 10.5 MHz               */
