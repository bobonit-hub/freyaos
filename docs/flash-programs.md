...
70528 bytes, through `0x0801D3FF`, rather than the 20352 bytes that fit in a
...
least 128 KiB. The Blue Pill program region runs to `0x0801D3FF`; the last
11 KiB is the kernel extension. The size used by `sysinfo`,
