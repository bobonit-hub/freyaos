...
77696 bytes, through `0x0801EFFF`, rather than the 20352 bytes that fit in a
...
least 128 KiB. The Blue Pill program region runs to `0x0801EFFF`; the last
4 KiB is the kernel's thread scheduler. The size used by `sysinfo`,
