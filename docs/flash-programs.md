...
37760 bytes, through `0x080153FF`, rather than the 20352 bytes that fit in a
...
least 128 KiB. The Blue Pill program region runs to `0x080153FF`; the last
43 KiB is the kernel extension. The size used by `sysinfo`,
