...
def run():
    ...
    ok("echo a # note; echo hidden", "a comment runs to the end of the line", "a")
    ok("# note; echo hidden", "a comment line is skipped", "")
    ok("echo hi#there", "a hash inside a word is not a comment", "hi#there")
